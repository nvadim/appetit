      ...
      <main class="content container">
        ...
        <div class="profile-form">
          <div class="profile-tabs">
            <nav>
              <ul>
                <li class="active"><a href="<?=SITE_DIR?>my/">
                    ...
                    </div><span class="font-fix"><?=GetMessage("my_history_title");?></span></a></li>
                    <?php if(\COption::GetOptionString('bd.deliverypizza', 'BD_SUB_MODULE_BONUSES_ENABLED','',SITE_ID) == 'Y'): ?>
                <li><a href="<?=SITE_DIR?>my/bonus/">
                    ...
                    </div><span class="font-fix"><?=GetMessage("my_bonus_title");?></span></a></li>
                    <?php endif; ?>
                <li><a href="<?=SITE_DIR?>my/edit/">
                    ...
                    </div><span class="font-fix"><?=GetMessage("my_edit_title");?></span></a></li>
              </ul>
            </nav>
          </div>
          <?$APPLICATION->IncludeComponent(
