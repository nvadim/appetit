            ...
            <nav>
              <ul>
                ...
                <li class="active"><a href="#" data-section="recommend"><?=GetMessage("recommend");?></a></li>
	              <?php endif; ?>
                <li <?php if(empty($rec_ids)): ?>class="active"<?php endif; ?>><a href="#" data-section="popular"><?=GetMessage("popular");?></a></li>
                <?
...
<?php endif; ?>
<div data-section="popular" class="row product-list index-products <?php if(empty($rec_ids)): ?>first<?php endif; ?>">
	<?$APPLICATION->IncludeComponent(
	"bitrix:catalog.top",
	"",
	array(
