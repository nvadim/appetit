            ...
            <div class="product-options">
	          ...
	          <div itemprop="offers" itemscope itemtype="http://schema.org/Offer" class="product-prices font-fix">
	                  <span class="old-price" <?if(!$arResult["OLD_PRICE"]):?>style="display: none;" <?endif;?>>
	                  	<span class="line-through"><?=number_format($arResult["OLD_PRICE"],0 ,'.',' ');?></span><span class="currency"><?=CURRENCY_FONT; ?></span>
	                  </span>
		          <span class="current-price"><span itemprop="price"><?=number_format($arResult["PRICE"],0 ,'.',' ');?></span><span class="currency"><?=CURRENCY_FONT; ?></span>
