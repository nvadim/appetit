...
{
    Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/bitrix/js/altasib.feedback/jquery.maskedinput/jquery.maskedinput.min.js");
}

if($arParams["USE_CAPTCHA"] == "Y" && $arParams["CAPTCHA_TYPE"] == "recaptcha")
{
    Asset::getInstance()->addJs("https://www.google.com/recaptcha/api.js?onload=AltasibFeedbackOnload_'.$ALX.'&render=explicit&hl='.LANGUAGE_ID");
}
