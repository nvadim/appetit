...
foreach($arResult["ITEMS"] as $PID => $arItem)
{
	foreach($arItem["VALUES"] as $key => $ar)
	{
		...
		if(isset($_CHECK[$ar["CONTROL_NAME"]]['type']) && $_CHECK[$ar["CONTROL_NAME"]]['type']=='E_'){
			$arResult["ITEMS"][$PID]["VALUES"][$key]["EXCLUDE"] = true;
		}
